...
{*/                                                                         }
{//-------------------------------------------------------------------------}
{*** CAVERNS OF KROZ II title stuff.  By Scott Miller 08/31/89 ***}
...
uses CRT, DOS, CAVERNS1, CAVERNS2, CAVERNS3;
    ...
    if ((PF[XLoop,YLoop] > 0 )or(FloorPattern)) and (not HideLevel) then
     begin
      ...
      case PF[XLoop,YLoop] of
       ...
       {punct.}   222:begin col(15,0);bak(6,7);write('!');bak(0,0)end       
       {LETTERS} else begin
                       col(15,0);bak(6,7);
...
procedure Tome_Message;
 begin
  ...
  Flash(18,25,' the Priceless Amulet of Kroz. ');
