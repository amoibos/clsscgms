...
procedure Shareware(Wait: boolean);
 begin
  ...
  gotoxy(24,1);
  writeln('RETURN TO KROZ Ä HOW TO REGISTER');
  gotoxy(1,2);
  ...
  for YLoop:=1 to YSize do
   for XLoop:=1 to XSize do
    ...
    case char(tempstr[1]) of
     ...
     'ñ':PF[XLoop+1,YLoop+1]:=58;
     'ò':PF[XLoop+1,YLoop+1]:=59;
     'ó':PF[XLoop+1,YLoop+1]:=60;
     'ô':PF[XLoop+1,YLoop+1]:=61;
     'õ':PF[XLoop+1,YLoop+1]:=62;
     'ö':PF[XLoop+1,YLoop+1]:=63;
...
procedure Level5;
 begin
  ...
  FP[15]:='W#o#    * 2             --X####X####X--       *           *  ##*';
  FP[16]:='W###              *          ## ##              ---2   *   W2##2';
  FP[17]:='W#h#       *       99999999999# #99999999999    -ö############# ';
...
procedure Level13;
 begin
  FP[1]:= '----XXVVVVVVV##K-333##     #Cö###thank#you#for#playing#kroz####K';
  FP[2]:= '-####VV+++++VV### U3##  P  ##9#################################-';
  FP[3]:= '-###VV+++++++VV##333##                ****3333333C-##  K##W-3) X';
  FP[4]:= '-##VVV+++++++VVV######## ####;#;#;#;# #XX***######`## U ####3) X';
  FP[5]:= '-1##VV+++++++VV####C##* ] *##3#3#3#3#ö#XX##H######`##T V##*-3) X';
  ...
  FP[14]:='OOOóOOOOOOOOORRRRRRO###########*# ###//###.#.#Z##(#(#(#(####3) X';
...
procedure Level15;
 begin
  FP[1]:= 'VVVV%%%%%%///2)))2)))2)))2)))2)))2)))2)))2)))2)))2))))))))))ô7-[';
  FP[2]:= 'VVVVVV#############################################XXXXXX)))ô7U-';
  FP[3]:= 'VVVVVVV-----------2222222222222222222222222222222)))))))))))ô777';
  FP[4]:= '<VVVVVVVOOOOOOOOO--222222222222222222222))))))--------------ôôôô';
  FP[5]:= '666VVVVVVVOOOOOOOO--22222222222222222222)##DD##H++++++++++++++++';
  FP[6]:= '8888VVVVVVVOOOOOOOO--22222222B2222222222)##DD###################';
  FP[7]:= '    2VVVVVVVKOOOOOOO-2222222222222222222)##DD`-----2---C-I--.-]ñ';
  ...
  FP[13]:=' 2      2     VVVVVVVVXXXXXXXX-222222222------T------2--2--2-]òK';
  ...
  FP[21]:='ööö        /////       VVVVVVVV)))))))))))))))))))))))))))))))))';
  FP[22]:='99ööööö    * //        VVVVVVVVV)))))######################88###';
  FP[23]:='|9.....          2     VóVVVVVVVV))))888888888888Q888888888888õK';
  Slow:=#142; Medium:=#148; Fast:=#234;
  Convert_Format;
 end; { Level15 }
...
procedure Level17;
 begin
  FP[1]:= '<3333333333333333333333333333333#K#OOOOOOOOOOOOOOOOOOOó33333333[';
  FP[2]:= '33333333333333333333333333333333#ô#33333333333333333333333333333';
  ...
  FP[21]:='3333333333333333333333#WWWWW#####ô#MMMMMMMMMX333333333---3333333';
  FP[22]:='3333###################-#####* !#ñ#MMMMMMMMMX333333333-U-3333333';
  FP[23]:='|33388888888888888DDDDD-õDLL#  ò#K#MMMMMMMMMX333333333---333333"';
...
procedure Level19;
 begin 
  ...
  FP[6]:= 'R-----]-----ñRRRK3333XXXXRRZRW1;-1RRXXXXXXXXXRR-R///RXXXXXXR-RDR';
  ...
  FP[12]:='-RRRRRRRRRRRRRRRR RR-]]-]-]]]]-]]-]R;RR"þþþþþþþþþ[RR333RR-RRRR+R';
  FP[13]:='------------R     RR]--]-]?*--]--]*RKRRþþþþtheþþþþRR333RR-R2RR+R';
  FP[14]:='R-RRRRRRRRR-R RRRRRRRRRRRRRRRRRRRRRRRRRþþþwaterþþþRR333RR-R+RR+R';
  FP[15]:='R4444444-UR------R-M                -RRþlabyrinthþRR...RR--+RR+R';
  FP[16]:='RRRRRRRRRRRRRRRR-R-RRRRRRRRRRRRRRRRR-RRþþþþþþþþþþþRR...RR-RRRR2R';
  FP[17]:='-RU-XXXX3333-TKR-R-R*R+3-2-2-1-1-RCR-RR<þþþþþþþþþ|RR...RR-*2RRKR';
  ...
  FP[23]:='---+--+--+--+--ò---RRRRRRRRRRRRRRR-M             R------------RR';
...
procedure Level20;
 begin
  ...
  FP[8]:= 'O#+@2@ - ##3##XXXXX##3## 3 - 3)MMMMMMMMM   #######smúwasúhere# X';
  FP[9]:= 'O#+@2@2 3 ##3##EEE##3##2 -   -))   -N   - &##CCC##T]***Q***]T# X';
  FP[10]:='G#+@2@3  - ##3##D##3## 3- 2-3  -#############777############## #';
  FP[11]:='O#+@2@ - 2-3##3#D#3##2 - 2  - - 77---------------ô;K++++CCC3ó#U#';
  ...
  FP[16]:='K#+@2@3 - 2 - ##5##2- #@@@@@# ################################-#';
  FP[17]:='O#+@2@ - 3 - 2##5## 3 #MMMMM#2##<)C)))333333)))K##òI=II=IT==I=I=';
  FP[18]:='O#+@2@3 2 2  -##5## - #MMMMM#2##))))333333)))))T##I=I==I=I=I=I==';
  FP[19]:='O#+@2@ -2-  3 ##D##3-2#MMMMM#@##))333333)))õõõ44##I======I=I====';
  FP[20]:='O#+@2@ -   3-2##H##  -#MMMMM#;##33333))))õõõ444V##=II===I===II==';
  FP[21]:='O#+@2@3 -2- - ##`##- 3#MMMMM#Z##))))))õõõõ44GVVV##===I=G======I=';
  FP[22]:=']#+@2@  - 32 -##`## 2 #MMMMM####õõõõõõõõ444VVVVV##=I=I=I=II=I=I=';
  FP[23]:='?#+@2@ -3  -3   -  3- #MMMMM88Iñõõõõõõõ44VVVVVVV##K=I===I==I=I*=';
