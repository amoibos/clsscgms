...
{*/                                                                         }
{//-------------------------------------------------------------------------}
{*** RETURN TO KROZ title screen procedure.  By Scott Miller 07/30/89 ***}
...
procedure Title;
 ...
 begin
  ...
  gotoxy(32,1);
  col(4,7);bak(1,0);
  write('ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ');
  gotoxy(32,3);
  write('ßßßßßßßßßßßßßßßß');
  gotoxy(25,5);col(15,15);
  write('An Apogee Software Production');
  gotoxy(28,7);
  write('Created by Scott Miller');
  gotoxy(1,9);col(11,7);
  writeln('  In your search for the precious Crown within the mysterious kingdom of Kroz');
  writeln('  you have blundered upon a secret passage leading deep into the Earth.  With');
  writeln('  your worn lantern you journey downward void of fear,  sweat beading on your');
  writeln('  forehead as you anticipate great treasures.  Undoubtedly, the Crown must be');
  ...
  repeat
   ...
   gotoxy(7,6);
   write('Version 1.2 -- Volume I of the Super Kroz Trilogy by Scott Miller');
   gotoxy(1,8);
   col(4,7);
   ...
   case upcase(ch) of
    ...
    'I':begin
         ...
         gotoxy(32,3);          writeln('ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ');
         writeln;
         col(15,7);
         writeln('   Return to Kroz is a game of exploration and survival.  Your journey will');
         writeln(' take you through 20 very dangerous chambers, each riddled with diabolical');
         writeln(' traps and hideous creatures.   Hidden in the deepest dungeon lies the');
         writeln(' priceless Crown of Kroz--your quest. Use the cursor pad to move 8 directions.');
         ...
         writeln('   Registered users can request a "Hidden Tricks and Hints" sheet if needed.');
         ...
         writeln;
         col(15,7);
         writeln('   Return to Kroz will present you with many challenges.  You will venture deep');
         writeln(' underground and probably not make it out alive!');
         writeln;
         writeln(' Hints:  þ Use your player to touch each new object to find out about it.  When');
         writeln('           you first touch an object a message appears at the bottom of the');
         writeln('           screen that describes it.');
         writeln('       þþ> Don''t forget to use the Home, End, PgUp, and PgDn keys to move your');
         writeln('           on-screen character diagonally (along with the marked cursor keys).');
         writeln('         þ Collect keys to unlock doors, which usually block the stairs going.');
         writeln('         þ The faster monsters are the most dangerous to touch--they will knock');
         ...
         writeln('         þ Nearly every new level presents you with new objects to discover.');
         writeln;
         writeln('   To prove to you that this game CAN be completed, let me say (or brag) that I');
         writeln(' have finished this game on the "Advanced" skill level, with over 120 gems and');
         writeln(' 60 whips left to spare.  On the "Novice" level I can play and win one handed!');
         writeln('   There''s many secret tricks in this game that can help you (even on Level 1)');
         writeln(' but even without these hidden maneuvers you can complete Return to Kroz.');
         flash(27,25,'Press any key to continue.');
        end;
    'M':begin
         ;
         ...
         gotoxy(29,3);          writeln('ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ');
         writeln;
         col(15,7);
         writeln('   Return to Kroz is a user-supported game.  This means that the creator of');
         ...
         writeln('   A single Kroz games takes nearly six months to create, or, over 200 hours!');
    ...
    'S':begin
         ...
         writeln('   The latest Kroz game, The Lost Adventures of Kroz, came about as a direct');
         writeln(' result of players requesting more, more, more Kroz!  So I delivered the goods.');
         flash(27,25,'Press any key to continue.');
        end;
    'O':begin
         ;
         ...
         gotoxy(27,3);          writeln('ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ');
         writeln;
         col(15,7);
         ...
         writeln(' Kroz games are:   þ Kingdom of Kroz  þ Caverns of Kroz  þ Dungeons of Kroz.');
         ...
         writeln(' mail to:  4206 Mayflower ù Garland, TX 75043.  Call 214/240-0614 for info.');
   ...
   begin
    ...
    for x:=1 to 15 do
     with HSList[x] do
      begin
       case x of
        1:begin Name:='Scott Miller';HighScore:=10963;HighLevel:=11;end;
        2:begin Name:='I. Jones';HighScore:=4281;HighLevel:=5;end
    ...
    if PF[XLoop,YLoop] > 0 then
     begin
      ...
      case PF[XLoop,YLoop] of
       ...
       {Crown}     24:begin col(15,15);write(Crown)end;
       ...
       {Create}    35:begin col(15,7);write(Chance)end;
       ...
       {CWall1..3} 55..57:;
       {OSpell1..3}58..60:begin col(11,7);write(OSpell1)end;
       {CSpell1..3}61..63:;
 ...
 begin
  ...
  case integer(Thing) of
   ...
   10,15,16,18,36,48..51:
      ...
      24:begin col(15,15);write(Crown)end;
