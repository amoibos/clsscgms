...
procedure Shareware(Wait: boolean);
 begin
  ...
  gotoxy(19,1);
  writeln('THE FINAL CRUSADE OF KROZ Ä HOW TO REGISTER');
  gotoxy(1,2);
...
procedure Level3;
 begin
  ...
  FP[12]:='#.####T********T********T####-##-444444444-4-4-4ñ##O#-1-1-1-##))';
...
procedure Level5;
 begin
  ...
  FP[12]:='O##ô77   2    2  T  2    2  -  -   -  -  2  2 - 2  RRRRRRRRR!---';
  ...
  FP[16]:='####W##########W##########W##########W##########W##########W####';
  FP[17]:=';;;;-;;;;##XXXXXXXXX##---------##2-2-2-2-2##úúúúúúúúú##2226-----';
  FP[18]:=';T;;;-;;##XXXXXXXXXXX##;;;;;;-##2-2-2-2-2-2##úúúúúúú##222266666-';
  FP[19]:='-;-;;;-;;##XXXXXXXXX##---------##2-2-2-2-2##úúúúúúúúú##22222226-';
  FP[20]:='-;;-;;;-;B##XXXXXXX##B---------B##2-2-2-2##BúúúúSúúúúB##2222226-';
  FP[21]:=';-;;-;-;;##XXXXXXXXX##VVVVVVVVV##2-2-2-2-2##úúúúúúúúú##22222226-';
  FP[22]:=';-;;;-;;##XXXXXXXXXXX##VVVVVVV##2-2-----2-2##úúúúúúú##222222226ó';
...
procedure Level7;
 begin
  ...
  FP[12]:='K@@@@@@@@@@@@W                 0P0        HB11111111111B1111111ñ';
  ...
  FP[22]:='1((((((((((((((((((1##-#####################)))))))333))))-*I*I*';
  FP[23]:='ó1111111111111111111##C-------D-D-D]]Eò&LL##K)))))333))))-*I*I*I';
  Slow:=#142;{or #154} Medium:=#153;{or #148} Fast:=#234;{or #1}
  Convert_Format;
...
procedure Level9;
 begin
  ...
  FP[5]:= '   #############################################################';
  FP[6]:= ' 0 ##!ö   TT          I  .            .     . ;;Q   .      . 88K';
  FP[7]:= '  0  0  0 ##7777P  .  I           .       .   ;;;;;     .    88õ';
  FP[8]:= ' 0  0 0   ##ôô77      I     .                    .           88õ';
  FP[9]:= '9999999999##Kô77      I   .         .        .        .     .88K';
  FP[10]:='############@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@';
  ...
  FP[14]:='MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMñMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM';
  ...
  FP[17]:='K@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@K';
  FP[18]:='MMMMMMMMMMMMMMMMòMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMóMMMMMMMMMMMMMMMM';
...
procedure Level11; 
 begin
  ...
  FP[8]:= '334  ~~~~~~~~~~~~~~~~~~~~~~~~~~I~1111111## ==== ##~*~-~~~ö######';
  FP[9]:= '334  ~K-U-7ô0~0~0~0~0~0~0~XXXK~I~11111111##0==== ##~~~~~33333333';
  FP[10]:='334  ~~~~~~~~~~~~~~~~~~~~~~~~~~I~111111111##-==== ##~~~333333333';
  FP[11]:='444ññ~~~~~~~~~~~~~333333~~~111~I~1111B11111##-==== ##~3333333333';
...
procedure Level13;
 begin
  ...
  FP[6]:= '```##6##@@0222222222000---(((((((((((((((ñ(((((000222222-C00000-';
  ...
  FP[21]:='00000-00000000000000000---000-00000001110-000K--<000OO000OOOOOó*';
...
procedure Level15;
 begin
  ...
  FP[3]:= ']]]]]]]]?6633##ñ##33-=-===--=Z=663333333-K66-----\\\H66636363636';
  ...
  FP[14]:='ò666666666666666666066666DDD66666-6666666666I6666666666$6$6$6$6$';
  ...
  FP[18]:='..........-----;--ô66---00B00-66--YYYYYYY66W;W;W;W;W;66;;;;;;;;;';
  FP[19]:='.........66----;--ô[66--00T00-----YYYYYYY<66W;W;W;W;W;          ';
...
procedure Level17;
 begin
  FP[1]:= 'KMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMóMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMK';
  FP[2]:= '@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@';
...
procedure Level24;
 begin
  ...
  FP[23]:='VVVVVVVVVVVVVVVVVVVVVVVVVVLLLLVVVVVVVVVVVVVVVtoo#hùoùtVVVVVVVVVV';
  Slow:=#143; Medium:=#153; Fast:=#234;
  Convert_Format;
...
procedure Level25;
 begin
  ...
  FP[2]:= '######4####################S####################################';
  FP[3]:= '<0[0|0"##ñ\\\\\##22222222)   N##C+++õ~                3333333333';
  FP[4]:= '0000000##\\\\MM##)))))))))    #######~888888888~~~~~~~~~~K~~~~~ ';
  FP[5]:= 'MMMMMMM##\\MMMM##                                0    Hò~~~CC]I ';
  FP[6]:= '*******##\MMMMM##     )RRR]                    ~~~~~~~~-~~~~~~~ ';
