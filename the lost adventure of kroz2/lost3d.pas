...
uses CRT, DOS, Lost1D, Lost2D, Lost2BD;
...
procedure Title;
 ...
 begin
  ...
  repeat
   ...
   writeln;col(15,15);gotoxy(13,wherey);
			writeln('THE FULLY-PLAYABLE DEMONSTRATION VERSION -- 75 LEVELS!');
  ...
  repeat
   ...
   gotoxy(6,8);
   col(14,15);
   writeln('THIS GAME IS MEANT TO BE PLACED IN ALL SHAREWARE LIBRARIES AND ON ANY');
   gotoxy(5,9);
   writeln('BULLETIN BOARD SYSTEM.  PLEASE SHARE IT WITH ALL OF YOUR FRIENDS, TOO!!');
   gotoxy(1,10);
   col(4,7);
